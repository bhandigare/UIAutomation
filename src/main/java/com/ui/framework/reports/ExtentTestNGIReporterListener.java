package com.ui.framework.reports;
...
public class ExtentTestNGIReporterListener implements IReporter {
	...
	private void init() {
		...
		ExtentSparkReporter htmlReporter = new ExtentSparkReporter(OUTPUT_FOLDER + "index" + FILE_NAME);

		htmlReporter.config().setDocumentTitle("Build No");
		htmlReporter.config().setReportName("UI Automation");
